...
export default function PumpPlaceholderPage({ params }: PageProps) {
  ...
  return (
    <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm max-w-xl mx-auto text-center font-sans space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <div className="w-16 h-16 bg-emerald-100 text-[#1D9E75] rounded-full flex items-center justify-center mx-auto text-2xl">
        🤱
      </div>
      <div>
        <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Nhật ký hút sữa</h1>
        <p className="text-sm text-gray-400 mt-2 font-medium">
          Đo lường lượng sữa hút hai bên (trái, phải), thời lượng hút sữa và đồng bộ với kho sữa.
        </p>
      </div>
